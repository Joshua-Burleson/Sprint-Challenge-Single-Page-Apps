...
> Answer: Client-side routing allows for faster routing after the application is initially loaded, minimizes network traffic and demand on the back-end, and allows the application to routed through offline (in routes that don't require backend or other API related verification or data).
